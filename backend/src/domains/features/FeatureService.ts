...
const DEFAULT_FEATURES: FeatureConfigMap = {
  ...
  ai_query: { enabled: true, tiers: ['free', 'starter', 'pro', 'enterprise'], limits: { free: 5, starter: 10, pro: 100, enterprise: 1000 } },
  ai_voice: { enabled: true, tiers: ['free', 'starter', 'pro', 'enterprise'] },
  ...
  partner_credit_api: { enabled: true, tiers: ['enterprise'] },
};
