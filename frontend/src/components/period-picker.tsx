...
const PERIOD_ITEMS = ["monthly", "yearly"] as const;
...
export function PeriodPicker<TItem extends string>({
  ...
  const displayItems = items || PERIOD_ITEMS;
  const displayValue =
    defaultValue === "monthly"
      ? t("dashboard.paymentsOverview.monthly")
      : defaultValue === "yearly"
        ? t("dashboard.paymentsOverview.yearly")
        : defaultValue || t("dashboard.paymentsOverview.timePeriod");
